  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-primary/10 via-white to-emerald-50 py-16 sm:py-24">
      ...
      <div className="relative mx-auto max-w-5xl px-4 text-center sm:px-6 lg:px-8">
        <h2 className="text-3xl font-semibold text-slate-900 sm:text-4xl">Готовы сделать команды спокойнее и вовлечённее?</h2>
        <p className="mt-3 text-lg text-slate-600">Запустите бесплатный trial или забронируйте демо. Мы покажем, как StressSense поможет HR и менеджерам действовать уверенно.</p>
