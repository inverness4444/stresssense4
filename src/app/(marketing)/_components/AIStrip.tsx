...
export default async function AIStrip() {
  ...
  const aiItems = isRu
    ...
    : [
        { title: "AI coach", text: "Conversational coach for employees and managers, without medicine or diagnoses." },
        { title: "AI summaries", text: "Short survey and team briefs so you see risks in minutes." },
        { title: "AI recommendations", text: "Tips for actions, habits, courses, and 1:1s — personal and safe." },
      ];
  return (
        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          <div className="max-w-xl space-y-3">
            ...
            <h2 className="text-3xl font-semibold sm:text-4xl">
              {isRu ? "AI, который коучит и автоматизирует, а не только отчёт" : "AI that coaches and automates, not just reports"}
            </h2>
            <p className="text-base text-indigo-100">
              {isRu
                ...
                : "StressSense AI works on aggregates with privacy by default: no personal diagnoses, only guidance and actions."}
            </p>
          </div>
          <div className="rounded-3xl bg-white/10 p-6 shadow-xl ring-1 ring-white/10 backdrop-blur">
            ...
            <div className="mt-4 rounded-2xl bg-white/10 p-4 text-xs text-indigo-100">
              {isRu
                ...
                : 'Example: “Team risk is up because of deadlines. Schedule 1:1s, rebalance tasks, and add a “90-min focus block” habit.”'}
            </div>
          </div>
        </div>
      </div>
